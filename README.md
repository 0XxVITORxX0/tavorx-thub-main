...
local v15 = v14:CreateWindow({
    Title = "tavorxt hub  v1.0",
    SubTitle = "join discord https://discord.gg/rJ45dYzAjX",
    TabWidth = 160,
    Theme = "Dark",
    Acrylic = false,
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=111618654196795";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Description = "discord server support",
    Callback = function()
...
if Sea3 then
    ...
    v16.Sea:AddButton({
        Title = "tp ship",
        Description = "The Only Boat You Buy at Your Choice",
        Callback = function()
            v521();
        end
    });
...
local v77 = v16.ITM:AddToggle("ToggleAutoObservationV2", {
    Title = "lget quest for doing get it ken haki v2",
...
if Sea2 then
    local v539 = v16.Main:AddToggle("ToggleSwordLengend", {
        Title = "buy legendary sword in sea 2",
...
local v107 = v16.Stats:AddToggle("ToggleMelee", {
    Title = "choose upgrade stats melee",
...
local v108 = v16.Stats:AddToggle("ToggleDe", {
    Title = "choose upgrade stats defense",
...
local v109 = v16.Stats:AddToggle("ToggleSword", {
    Title = "choose upgrade stats shord",
...
local v110 = v16.Stats:AddToggle("ToggleGun", {
    Title = "choose upgrade stats gun",
...
local v111 = v16.Stats:AddToggle("ToggleFruit", {
    Title = "choose upgrade stats fruit",
...
local v119 = v16.Teleport:AddToggle("ToggleAutoSea2", {
    Title = "auto doing quest to join second sea",
...
local v120 = v16.Teleport:AddToggle("ToggleAutoSea3", {
    Title = "auto doing quest for join third sea",
...
local v121 = v16.Teleport:AddDropdown("DropdownIsland", {
    Title = "choose island for teleport",
...
local v124 = v16.Fruit:AddDropdown("DropdownPermanentFruit", {
    Title = "choose premium fruit (if you have in shop)",
...
local v125 = v16.Fruit:AddToggle("TogglePermanentFruit", {
    Title = "change premium fruit (if you have in shop)",
...
local v134 = v16.Fruit:AddToggle("ToggleEspRealFruit", {
    Title = "positioning fruit to get ken haki  v2",
...
local v140 = v16.Raid:AddToggle("ToggleNextIsland", {
    Title = "auto raid and teleport to next island",
...
local v142 = v16.Raid:AddToggle("ToggleGetFruit", {
    Title = "gets fruit below 1m beli for doing raid",
...
v16.Race:AddButton({
    Title = "teleport to ur race door",
...
local v144 = v16.Race:AddToggle("ToggleHumanandghoul", {
    Title = "finished trials human or [ghoul race]",
...
local v146 = v16.Race:AddToggle("ToggleKillTrial", {
    Title = "auto kill player in trials",
...
v16.Shop:AddButton({
    ...
    Description = "change to race ghoul",
    Callback = function()
        local v366 = {
            [1] = "Ectoplasm",
            [2] = "Change",
...
v16.Shop:AddButton({
    ...
    Description = "change to race cyborg",
    Callback = function()
        local v367 = {
            [1] = "CyborgTrainer",
            [2] = "Buy"
...
local v151 = v16.Misc:AddToggle("ToggleRejoin", {
    ...
    Description = "rejoin sever again",
    Default = true
});
...
local v155 = v16.Sea:AddToggle("ToggleTPFrozenDimension", {
    ...
    Description = "teleport to island frozen dimension",
    Default = false
});
...
if Sea3 then
    local v561 = v16.Sea:AddParagraph({
        Title = "check status frozen dimension in sever or no",
        Content = "check status frozen dimension in sever or no"
    });
    spawn(function()
        pcall(function()
...
local v159 = v16.Sea:AddParagraph({
    Title = "check status BlazeEmber question (red fire)",
...
local v160 = v16.Sea:AddToggle("ToggleHydraTree", {
    Title = "brake trees in hydra for done dojo quest",
...
local v164 = v16.Sea:AddToggle("ToggleCollectFireFlowers", {
    Title = "auto gets red follower for upgrade draco race",
...
local v169 = v16.Sea:AddParagraph({
    Title = "check status volcano in sever or no",
...
local v170 = v16.Sea:AddToggle("ToggleTPVolcano", {
    Title = "teleport when volcano spawn in sever",
